...
%% Comandos específicos para PREENCHER O GABARITO na folha de respostas (NÃO ALTERAR)
\newcommand{\extext}[1]{\textbf{\large #1}} % Imprime a resposta em negrito
...
\newcommand{\exstring}[1]{%
  \mbox{\framebox[0.9\textwidth][l]{\rule[-1mm]{0mm}{5mm} \hspace*{-1.6mm} \textbf{Gabarito discursiva:} \extext{#1}} \hspace*{2mm}}%
}
...
%% página de rosto / cabeçalho principal com folha de respostas
\thispagestyle{empty}
{\sf
\begin{center}
...
\vspace{0.3cm}
Respostas corretas destacadas nos campos abaixo:
\vspace{0.5cm}
...
% Início dos exercícios (Gabarito comentado)
\begin{enumerate}
