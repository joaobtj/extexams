...
\begin{center}
    ...
    \textbf{\large Prova de \myCourse \ -- Semestre \mySemester} \hfill \textbf{ID: \myID}
\end{center}

\vspace{0.3cm}

% Quadro limpo de identificação do aluno
\noindent\fbox{
  \begin{minipage}{\textwidth}
    \vspace{0.2cm}
    \textbf{Nome:} \hrulefill \\[0.4cm]
    \textbf{Matrícula:} \rule{5cm}{0.4pt} \hfill
    \textbf{Data:} \rule{4.5cm}{0.4pt}
    \vspace{0.2cm}
  \end{minipage}
}
