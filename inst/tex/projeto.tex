...
%% fontes: Helvetica (sem serifa, excelente para leitura de projetos)
\usepackage{helvet}
...
\begin{center}
    ...
    \textbf{\large Projeto de \myCourse \ -- Semestre \mySemester} \hfill \textbf{ID do Projeto: \myID}
\end{center}

\vspace{0.3cm}

% Quadro de identificação flexível (individual ou equipe)
\noindent\fbox{
  \begin{minipage}{\textwidth}
    \vspace{0.2cm}
    \textbf{Nome:} \hrulefill \\[0.4cm]
    \textbf{Matrícula(s):} \rule{6.5cm}{0.4pt} \hfill
...
% Início do projeto
\begin{enumerate}
\setlength{\itemsep}{1.5em} % Aumenta levemente o espaço entre os tópicos
%% \exinput{exercises}
\end{enumerate}
